...
internal sealed class ForgotPasswordCommandHandler(IUserRepository _userRepository, IUnitOfWork _unitOfWork, IMailService _mailService) : IRequestHandler<ForgotPasswordCommand, Result<string>>
{
